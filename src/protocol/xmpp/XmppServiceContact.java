    ...
    void nickOffline(Xmpp xmpp, String nick, int code, String reasone, String presenceUnavailable) {
        ...
        if (getMyName().equals(nick)) {
            ...
            if (0 != errorText) {
                ...
                //ru.sawimmod.modules.MagicEye.addAction(getProtocol(), getUserId(), nick + " " + text, reasone);
                xmpp.addMessage(new SystemNotice(xmpp,
            ...
            if (0 != eventCode) {
                ...
                //ru.sawimmod.modules.MagicEye.addAction(xmpp, getUserId(), nick + " " + event, reasone);
            }
        }
